              ...
              <Grid xs={12} sm={6} md={6} lg={3} key={index} item>
                ...
                >
                  ...
                  <Typography className={classes.subtitle} variant="body2">
                    {pool.token === 'pigAutoWbnbFixed' ? 'pigAutoWBNB' : pool.token}
                  </Typography>
                  <Button
                    xs={5}
                    md={2}
        ...
        <Grid className={classes.faq} item xs={12} lg={9}>
          <Accordion square expanded={expanded === 'faq-1'} onChange={handleChange('faq-1')}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>How do I use Piggybank Vault Launchpool?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                <img
                ...
                for in the vault. You will get a “receipt” called pigToken in your wallet. Proceed
                to the related partner Launchpool vault here on the Piggybank Vault Launchpool site and enter
                the corresponding vault (or press the shortcut on the main vault page called Boost).
                The vault will ask for you to stake your pigToken “receipts''. Stake these pigTokens
          ...
          <Accordion square expanded={expanded === 'faq-2'} onChange={handleChange('faq-2')}>
            ...
            <AccordionDetails>
              <Typography>
                Enter the vault where you deposited your pigTokens and it will show you a nice
          ...
          <Accordion square expanded={expanded === 'faq-4'} onChange={handleChange('faq-4')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                deposited PigTokens together with the partner tokens, at any time.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion square expanded={expanded === 'faq-5'} onChange={handleChange('faq-5')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                vaults, one by one, and then deposit your pigTokens (vault receipts) in the
          ...
          <Accordion square expanded={expanded === 'faq-6'} onChange={handleChange('faq-6')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                your pigTokens (vault receipts) in one of our partner vaults, the main boosted vault
                don’t see these receipts in your wallet, hence it shows you zero. As soon as you are
                finished with a partner vault, you withdraw your pigTokens (receipts) back to your
          ...
          <Accordion square expanded={expanded === 'faq-7'} onChange={handleChange('faq-7')}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>What are PigTokens?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                Once you stake in any of Piggybank Finance vaults, you get in return something called
                pigTokens. These are different depending on the vault you participate in, this can
                be called ‘pigCOINK’ or ‘pigAutoCake’. Basically, these are receipts for the funds
                ...
                pigTokens are exchanged back into the tokens you deposited + compound.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion square expanded={expanded === 'faq-8'} onChange={handleChange('faq-8')}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>What is pigCoink?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                pigCoink is the token you receive from depositing COINK into the Piggybank Maxi vault.
                These pigTokens do not 1:1 represent the token amount initially deposited but it
                does represent the value of your share in the vault. The Piggybank Maxi vault gathers a
                performance fee from every Piggybank Finance Vault when they are harvested, and uses it to buy
                more COINK and redeposit in the vault. The more profit the Piggybank Vault generates, the more
                COINK you'll own in the vault. Do NOT sell your pigTokens, or else you lose access
                to your deposit.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion square expanded={expanded === 'faq-9'} onChange={handleChange('faq-9')}>
            ...
            <AccordionDetails>
              <Typography>
                Yes! These partner vaults are hosted by Piggybank Vault and are completely safe. Piggybank Vault has
                gotten tokens from our partners and uses our own vaults for the reward. Those
                pigTokens your stake doesn’t leave Piggybank Vault.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion square expanded={expanded === 'faq-10'} onChange={handleChange('faq-10')}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>
                If I enter a partner vault with my pigTokens, will I still earn the ordinary vault
                reward?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
          ...
          <Accordion square expanded={expanded === 'faq-11'} onChange={handleChange('faq-11')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                Rate” and is a fixed rate. Piggybank Vault shows APR by dividing the annual yield into 365
                days and presents that to you as “Daily”. APY on the other hand means “Annual
                percentage yield” which is when you take the daily yield and compound it. Piggybank Vault
          ...
          <Accordion square expanded={expanded === 'faq-13'} onChange={handleChange('faq-13')}>
            ...
            <AccordionDetails>
              <Typography>
                When partnering with a certain project, Piggybank Vault always tries to make an overall check
                ...
                Piggybank Vault cannot, and will not take any responsibility for your personal actions.
              </Typography>
            </AccordionDetails>
          </Accordion>
          {networkId === 56 ? (
            <Accordion square expanded={expanded === 'faq-14'} onChange={handleChange('faq-14')}>
              ...
              <AccordionDetails>
                <Typography>
                  Buy our own token COINK, and stake it here in the COINK Gov vault and you will earn
